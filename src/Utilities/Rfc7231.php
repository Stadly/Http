...
final class Rfc7231
{
    ...
    public const RFC850_DATE =
        '(?:'.self::DAY_NAME_L.','.Rfc5234::SP.self::DATE2.Rfc5234::SP.self::TIME_OF_DAY.Rfc5234::SP.self::GMT.')';
     ...
     * Specification: https://tools.ietf.org/html/rfc7231#section-7.1.1.1 (date2)
     */
    public const DATE2_CAPTURE = '(?:'.self::DAY_CAPTURE.'-'.self::MONTH_CAPTURE.'-(?<YEAR>'.Rfc5234::DIGIT.'{2}))';
     ...
     */
    public const DATE3 = '(?:'.self::MONTH.Rfc5234::SP.'(?:'.Rfc5234::DIGIT.'{2}|'.Rfc5234::SP.Rfc5234::DIGIT.'))';
