...
final class Rfc7233
{
    ...
    public const BYTE_RANGE_SET
        = '(?:(?:,'.Rfc7230::OWS.')*(?:'.self::BYTE_RANGE_SPEC.'|'.self::SUFFIX_BYTE_RANGE_SPEC.')'
    ...
    public const BYTE_RANGE_SET_CAPTURE
        = '(?<BYTE_RANGE_SET>(?:,'.Rfc7230::OWS.')*(?:'.self::BYTE_RANGE_SPEC.'|'.self::SUFFIX_BYTE_RANGE_SPEC.')'
        . '(?:'.Rfc7230::OWS.',(?:'.Rfc7230::OWS.'(?:'.self::BYTE_RANGE_SPEC.'|'.self::SUFFIX_BYTE_RANGE_SPEC.'))?)*)';
     ...
     * Specification: https://tools.ietf.org/html/rfc7233#section-2.1 (byte-range-spec)
     */
    public const BYTE_RANGE_SPEC_CAPTURE = '(?:'.self::FIRST_BYTE_POS_CAPTURE.'-'.self::LAST_BYTE_POS_CAPTURE.'?)';
